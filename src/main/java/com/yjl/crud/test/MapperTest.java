package com.yjl.crud.test;


import com.yjl.crud.bean.Department;
import com.yjl.crud.dao.DepartmentMapper;
...
//        employeeMapper.insertSelective(new Employee(null,"nick","M","nick@guigu.com",1));
        ...
        for(int i=0;i<50;i++){
            ...
            mapper.insertSelective(new Employee(null,uid,"M",uid+"@shuwei.com",1));
        }*/
